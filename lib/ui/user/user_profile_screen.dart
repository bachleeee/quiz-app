...
class UsersProfileScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final quizzes = context
        .select<QuizManager, List<Quiz>>((quizsManager) => quizsManager.quizs);

    final playedQuizzesCount =
        quizzes.where((quiz) => quiz.isPlayed).toList().length;
          ...
          children: <Widget>[
            ...
            Expanded(
              child: GridView.count(
                crossAxisCount: 2,
                children: [
                  _buildStatCard('${user.coins}', 'Coins', Icons.stars),
                  _buildStatCard('$playedQuizzesCount', 'Games played',
